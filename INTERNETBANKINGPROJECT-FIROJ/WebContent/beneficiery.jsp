...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    import= "java.sql.*" import= "java.util.*" import="com.nt.servlet.*" import="java.lang.*"%>
 ...
 if(tacc!=null  &&  lim!=null&&  lim!="" &&tacc!="")
	{
		...
		Statement stmt=con.createStatement();
	 	...
	 	if(rs.next()){
	 		...
	 		sql="insert into bene(cac,tacc,lim) values("+a+","+Integer.parseInt(tacc)+","+Float.parseFloat(lim)+")";
