...
import javax.servlet.http.*;
 public class Controller extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	public void function(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		System.out.println("userAction::"+userAction);
			...
			{	RequestDispatcher rd=req.getRequestDispatcher("main.jsp");
				...
				if(userAction.equals("Corporate Banking")){
					rd=req.getRequestDispatcher("as.jsp");
			}
					...
					req.setAttribute("file","TRANSFERMONEY.jsp");
					rd=req.getRequestDispatcher("TRANSFERMONEY1.jsp");
					
				}
				/*else if(userAction.equals("TYPE HERE TO TRANSFER")){
					req.setAttribute("file","login.jsp");
					rd=req.getRequestDispatcher("main.jsp");
	...
	public void open(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException {
		try{
			System.out.println("===="+req.getParameter("logid"));
			String log=req.getParameter("logid");
	...
	public void pay(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException {
		try{
			PDAOU pdaou=new PDAOU();
			PDAO pdao=new PDAO();
			PersonInfo person=new PersonInfo();
	...
	public void emailu(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException {
		try{
			PDAOU pdaou=new PDAOU();
			PersonInfo person=new PersonInfo();
	...
	public void mobileu(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException {
		try{
			PDAOU pdaou=new PDAOU();
			PersonInfo person=new PersonInfo();
	...
	public void nameu(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException {
		try{
			PDAOU pdaou=new PDAOU();
			PersonInfo person=new PersonInfo();
